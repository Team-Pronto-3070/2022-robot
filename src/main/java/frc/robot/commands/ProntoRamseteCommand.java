 ...
 */
public class ProntoRamseteCommand extends CommandBase {
  ...
  /**
   * Constructs a new ProntoRamseteCommand that, when executed, will follow the provided trajectory. PID
  ...
  public ProntoRamseteCommand(
    ...
    m_trajectory = requireNonNullParam(trajectory, "trajectory", "ProntoRamseteCommand");
    m_pose = requireNonNullParam(pose, "pose", "ProntoRamseteCommand");
    m_follower = requireNonNullParam(controller, "controller", "ProntoRamseteCommand");
    m_feedforward = feedforward;
    m_kinematics = requireNonNullParam(kinematics, "kinematics", "ProntoRamseteCommand");
    m_speeds = requireNonNullParam(wheelSpeeds, "wheelSpeeds", "ProntoRamseteCommand");
    m_leftController = requireNonNullParam(leftController, "leftController", "ProntoRamseteCommand");
    m_rightController = requireNonNullParam(rightController, "rightController", "ProntoRamseteCommand");
    m_output = requireNonNullParam(outputVolts, "outputVolts", "ProntoRamseteCommand");
  ...
  /**
   * Constructs a new ProntoRamseteCommand that, when executed, will follow the provided trajectory.
  ...
  public ProntoRamseteCommand(
    ...
    m_trajectory = requireNonNullParam(trajectory, "trajectory", "ProntoRamseteCommand");
    m_pose = requireNonNullParam(pose, "pose", "ProntoRamseteCommand");
    m_follower = requireNonNullParam(follower, "follower", "ProntoRamseteCommand");
    m_kinematics = requireNonNullParam(kinematics, "kinematics", "ProntoRamseteCommand");
    m_output = requireNonNullParam(outputMetersPerSecond, "output", "ProntoRamseteCommand");
  ...
  public ProntoRamseteCommand(Trajectory traj, Drive_s drive) {
      this(traj,
           drive::getPose,
